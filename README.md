...
This repository is used to distribute NetMon release packages.                                                                                                                                                                                Download the latest deployment assets from the **Releases** page.                                                                                                                                                                     Current release assets:                                                                                                
                      - `netmon-server-20260406-195615Z.zip`
                      - `netmon-agent-20260406-195615Z.zip`
                      - - `SHA256SUMS.txt`                                                                                                     
                      - `RELEASE_INFO.txt`                                                                                                                                                                                        Notes:                                                                                                                 
